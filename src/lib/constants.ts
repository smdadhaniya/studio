...
export const PRESET_HABITS: PresetHabitFormData[] = [
  ...
  },
  {
    ...
    description: "Expand your knowledge or enjoy a story.",
    trackingFormat: "measurable",
  ...
  },
  {
    ...
    description: "Nutritious eating for well-being.",
    trackingFormat: "measurable",
    measurableUnit: "servings",
    targetCount: 5,
    icon: "Apple",
  },
  {
    title: "Practice a new skill for 20 mins",
    description: "Learn coding, an instrument, etc.",
    trackingFormat: "measurable",
    measurableUnit: "minutes",
    targetCount: 20,
    icon: "Wrench",
  },
  {
    ...
    description: "Focused learning on a chosen topic.",
    trackingFormat: "measurable",
    measurableUnit: "minutes",
    targetCount: 15,
    icon: "Headphones",
  ...
  {
    title: "Tidy up for 15 minutes",
    description: "Keep your living space organized.",
    trackingFormat: "measurable",
    measurableUnit: "minutes",
    targetCount: 15,
    icon: "Sparkles",
  ...
  {
    title: "Practice gratitude (3 things)",
    description: "List three things you are grateful for.",
    trackingFormat: "measurable",
    measurableUnit: "items",
    targetCount: 3,
  ...
  // New Measurable (10 more)
  {
    ...
    description: "Work on your novel, blog, or journal.",
    trackingFormat: "measurable",
  ...
  },
  {
    ...
    description: "Develop your programming skills.",
    trackingFormat: "measurable",
  ...
  {
    title: "Spend 30 minutes on a hobby",
    description: "Engage in a relaxing activity.",
    trackingFormat: "measurable",
    measurableUnit: "minutes",
    targetCount: 30,
    icon: "Paintbrush",
  },
  {
    ...
    trackingFormat: "measurable",
    measurableUnit: "currency",
    targetCount: 10,
    icon: "PiggyBank",
  },
  {
    title: "Complete 3 work/study tasks",
    description: "Achieve your daily professional goals.",
    trackingFormat: "measurable",
    measurableUnit: "tasks",
    targetCount: 3,
    icon: "ClipboardCheck",
  },
  {
    title: "Walk 5,000 steps",
    description: "Stay active with a daily step goal.",
    trackingFormat: "measurable",
  ...
  {
    title: "No social media for 2 hours straight",
    description: "Focus without digital distractions.",
    trackingFormat: "measurable",
    measurableUnit: "hours",
    targetCount: 2,
    icon: "Shield",
  ...
  {
    title: "Learn 5 new vocabulary items",
  ...
  {
    title: "Practice musical instrument for 20 mins",
    description: "Hone your musical talents.",
    trackingFormat: "measurable",
    measurableUnit: "minutes",
    targetCount: 20,
    icon: "Music",
  ...
  {
    title: "Complete 1 module of an online course",
    description: "Progress in your online learning.",
    trackingFormat: "measurable",
    measurableUnit: "modules",
    targetCount: 1,
    icon: "GraduationCap",
  },
  ...
  // Existing Yes/No (10)
  {
    ...
    description: "Ensure adequate sleep for recovery.",
    trackingFormat: "yes/no",
    icon: "Bed",
  },
  {
    title: "Wake up at 6 AM",
    description: "Start your day early and productively.",
    trackingFormat: "yes/no",
    icon: "Alarm Clock",
  },
  {
    title: "No sugary drinks",
    description: "Opt for healthier beverage choices.",
    trackingFormat: "yes/no",
    icon: "Glass Water",
  },
  {
    title: "Write in a journal",
    description: "Reflect on your day, thoughts, and feelings.",
    trackingFormat: "yes/no",
    icon: "Pen Square",
  },
  {
  ...
  },
  {
    ...
    description: "Call or spend quality time.",
    trackingFormat: "yes/no",
    icon: "Users",
  },
  {
    title: "Work on a personal project",
    description: "Dedicate time to your passions.",
    trackingFormat: "yes/no",
    icon: "Lightbulb",
  },
  {
    title: "Review finances/budget",
    description: "Stay on top of your financial health.",
    trackingFormat: "yes/no",
    icon: "Dollar Sign",
  },
  {
    title: "Do something creative",
    description: "Painting, writing, music, etc.",
    trackingFormat: "yes/no",
    icon: "Palette",
  },
  {
    title: "Compliment someone",
    description: "Spread positivity and kindness.",
    trackingFormat: "yes/no",
    icon: "Smile",
  },
  ...
  // New Yes/No (10 more)
  {
    ...
    description: "A short break to refresh.",
    trackingFormat: "yes/no",
    icon: "Activity",
  },
  {
    title: "No snooze button",
    description: "Wake up right away.",
    trackingFormat: "yes/no",
    icon: "Sunrise",
  },
  {
    ...
    trackingFormat: "yes/no",
    icon: "Activity",
  }, // Using Activity as stretch icon is not available
  {
    title: "Drink a cup of green tea",
    description: "Enjoy a healthy beverage.",
    trackingFormat: "yes/no",
    icon: "Coffee",
  }, // Using Coffee as placeholder
  {
    title: "Listen to a podcast episode",
    description: "Learn something new or be entertained.",
    trackingFormat: "yes/no",
    icon: "Podcast",
  },
  {
    title: "Avoid processed foods for the day",
    description: "Focus on whole, natural foods.",
    trackingFormat: "yes/no",
    icon: "ChefHat",
  },
  {
  ...
  {
    title: "Call a family member or friend",
    description: "Nurture your relationships.",
    trackingFormat: "yes/no",
    icon: "Phone",
  },
  {
    title: "Learn one new word/fact",
  ...
  },
  {
    ...
    description: "Care for your green companions.",
    trackingFormat: "yes/no",
    icon: "Flower",
  },
];
